...
| Category | Name | Id | Classes | Weight | Band | Dependencies | PNG path(s) |
| --- | --- | --- | --- | ---: | --- | --- | --- |
| background | Winter Sunrise | `winter-sunrise` | shared | 140 | common |  | layers/shared/backgrounds/winter-sunrise.png |
| background | Snowy Camp | `snowy-camp` | shared | 140 | common |  | layers/shared/backgrounds/snowy-camp.png |
| background | Forest Clearing | `forest-clearing` | shared | 120 | common |  | layers/shared/backgrounds/forest-clearing.png |
| background | Cold Blue Night | `cold-blue-night` | shared | 90 | uncommon |  | layers/shared/backgrounds/cold-blue-night.png |
| background | Winter Sunset | `winter-sunset` | shared | 80 | uncommon |  | layers/shared/backgrounds/winter-sunset.png |
| background | Warm Dawn | `warm-dawn` | shared | 80 | uncommon |  | layers/shared/backgrounds/warm-dawn.png |
| background | Starry Winter Night | `starry-night` | shared | 50 | rare |  | layers/shared/backgrounds/starry-night.png |
| background | Campground | `campground` | shared | 90 | common |  | layers/shared/backgrounds/campground.png |
| background | Appalachian Ridge | `appalachian-ridge` | shared | 45 | rare |  | layers/shared/backgrounds/appalachian-ridge.png |
| background | City Edge | `city-edge` | shared | 55 | uncommon |  | layers/shared/backgrounds/city-edge.png |
| background | Quiet Overpass | `underpass-quiet` | shared | 30 | rare |  | layers/shared/backgrounds/underpass-quiet.png |
| background | Abstract Snowfield | `abstract-snow` | shared | 40 | rare |  | layers/shared/backgrounds/abstract-snow.png |
...
| arm_pose | Hold Item | `hold-item` | sleeping-bag, small-tent, large-tent | 280 | common | ['rear_arm', 'front_arm'] | layers/sleeping-bag/arms-rear/hold-item.png, layers/sleeping-bag/arms/hold-item.png, layers/small-tent/arms-rear/hold-item.png, layers/small-tent/arms/hold-item.png, layers/large-tent/arms-rear/hold-item.png, layers/large-tent/arms/hold-item.png |
...
| arm_pose | Two-Handed Hold | `hold-two-hand` | sleeping-bag, small-tent, large-tent | 40 | rare | ['rear_arm', 'front_arm'] | layers/sleeping-bag/arms-rear/hold-two-hand.png, layers/sleeping-bag/arms/hold-two-hand.png, layers/small-tent/arms-rear/hold-two-hand.png, layers/small-tent/arms/hold-two-hand.png, layers/large-tent/arms-rear/hold-two-hand.png, layers/large-tent/arms/hold-two-hand.png |
...
| body | Camp Orange | `camp-orange` | sleeping-bag, small-tent, large-tent | 90 | common |  | layers/sleeping-bag/body/camp-orange.png, layers/small-tent/body/camp-orange.png, layers/large-tent/body/camp-orange.png |
| body | Dusty Rose | `dusty-rose` | sleeping-bag, small-tent, large-tent | 85 | common |  | layers/sleeping-bag/body/dusty-rose.png, layers/small-tent/body/dusty-rose.png, layers/large-tent/body/dusty-rose.png |
| body | Burgundy | `burgundy-quilt` | sleeping-bag | 70 | uncommon |  | layers/sleeping-bag/body/burgundy-quilt.png |
| body | Mustard Seed | `mustard-seed` | sleeping-bag | 70 | uncommon |  | layers/sleeping-bag/body/mustard-seed.png |
| body | Cream Fleece | `cream-fleece` | sleeping-bag | 60 | uncommon |  | layers/sleeping-bag/body/cream-fleece.png |
| body | Sky Flannel | `sky-flannel` | sleeping-bag | 55 | uncommon |  | layers/sleeping-bag/body/sky-flannel.png |
| body | Plum Preserve | `plum-preserve` | sleeping-bag | 40 | rare |  | layers/sleeping-bag/body/plum-preserve.png |
| body | Storm Charcoal | `storm-charcoal` | sleeping-bag, small-tent, large-tent | 55 | uncommon |  | layers/sleeping-bag/body/storm-charcoal.png, layers/small-tent/body/storm-charcoal.png, layers/large-tent/body/storm-charcoal.png |
| body | Forest Green | `forest-green` | small-tent, large-tent | 100 | common |  | layers/small-tent/body/forest-green.png, layers/large-tent/body/forest-green.png |
| body | Royal Blue | `royal-blue` | small-tent, large-tent | 80 | common |  | layers/small-tent/body/royal-blue.png, layers/large-tent/body/royal-blue.png |
| body | Sand Tan | `sand-tan` | small-tent, large-tent | 80 | common |  | layers/small-tent/body/sand-tan.png, layers/large-tent/body/sand-tan.png |
| body | Camp Red | `camp-red` | small-tent, large-tent | 60 | uncommon |  | layers/small-tent/body/camp-red.png, layers/large-tent/body/camp-red.png |
| body | Granite Gray | `granite-gray` | small-tent, large-tent | 55 | uncommon |  | layers/small-tent/body/granite-gray.png, layers/large-tent/body/granite-gray.png |
| body | Alpine Teal | `alpine-teal` | small-tent, large-tent | 40 | rare |  | layers/small-tent/body/alpine-teal.png, layers/large-tent/body/alpine-teal.png |
| body | Wild Purple | `wild-purple` | small-tent, large-tent | 30 | rare |  | layers/small-tent/body/wild-purple.png, layers/large-tent/body/wild-purple.png |
| body | Sun Yellow | `sun-yellow` | small-tent, large-tent | 30 | rare |  | layers/small-tent/body/sun-yellow.png, layers/large-tent/body/sun-yellow.png |
| body | Olive / Tan | `two-tone-olive-tan` | small-tent, large-tent | 35 | rare |  | layers/small-tent/body/two-tone-olive-tan.png, layers/large-tent/body/two-tone-olive-tan.png |
| body | Navy / Orange | `two-tone-navy-orange` | small-tent, large-tent | 35 | rare |  | layers/small-tent/body/two-tone-navy-orange.png, layers/large-tent/body/two-tone-navy-orange.png |
| body | Aurora Cloth | `aurora` | sleeping-bag, small-tent, large-tent | 12 | legendary |  | layers/sleeping-bag/body/aurora.png, layers/small-tent/body/aurora.png, layers/large-tent/body/aurora.png |
...
| eyes | Sleepy | `sleepy` | sleeping-bag, small-tent, large-tent | 110 | uncommon |  | layers/sleeping-bag/eyes/sleepy.png, layers/small-tent/eyes/sleepy.png, layers/large-tent/eyes/sleepy.png |
| eyes | Sunglasses Ready | `sunglasses-compatible` | sleeping-bag, small-tent, large-tent | 15 | rare |  | layers/sleeping-bag/eyes/sunglasses-compatible.png, layers/small-tent/eyes/sunglasses-compatible.png, layers/large-tent/eyes/sunglasses-compatible.png |
...
| mouth | Grin | `grin` | sleeping-bag, small-tent, large-tent | 150 | common |  | layers/sleeping-bag/mouths/grin.png, layers/small-tent/mouths/grin.png, layers/large-tent/mouths/grin.png |
| mouth | Determined | `determined` | sleeping-bag, small-tent, large-tent | 80 | uncommon |  | layers/sleeping-bag/mouths/determined.png, layers/small-tent/mouths/determined.png, layers/large-tent/mouths/determined.png |
...
| headwear | Knit Cap | `knit-cap` | sleeping-bag, small-tent | 90 | common |  | layers/sleeping-bag/headwear/knit-cap.png, layers/small-tent/headwear/knit-cap.png |
| headwear | Baseball Cap | `baseball-cap` | sleeping-bag, large-tent | 70 | uncommon |  | layers/sleeping-bag/headwear/baseball-cap.png, layers/large-tent/headwear/baseball-cap.png |
| headwear | Bucket Hat | `bucket-hat` | small-tent | 55 | uncommon |  | layers/small-tent/headwear/bucket-hat.png |
| headwear | Trapper Hat | `trapper-hat` | large-tent | 45 | rare |  | layers/large-tent/headwear/trapper-hat.png |
| headwear | Winter Santa Hat | `santa-hat` | sleeping-bag | 25 | rare |  | layers/sleeping-bag/headwear/santa-hat.png |
| headwear | Camp Crown | `crown` | large-tent | 12 | epic |  | layers/large-tent/headwear/crown.png |
| headwear | North Star Halo | `halo` | large-tent | 8 | legendary |  | layers/large-tent/headwear/halo.png |
| headwear | Earflap Beanie | `earflap-beanie` | sleeping-bag | 25 | rare |  | layers/sleeping-bag/headwear/earflap-beanie.png |
| ground_accessory | None | `none` | shared | 780 | common |  |  |
| ground_accessory | Tiny Campfire | `tiny-campfire` | shared | 25 | epic |  | layers/shared/ground/tiny-campfire.png |
